...
In reality, I'm quite often forced to bear with the tools I'm given, e.g. macOS or SAP...
> Eww&hellip; Brother, eww&hellip; What's that? What's that, brother?!

<hr/>

`unshare` doesn't mean I don't share.
It's a reference to [unshare(2)](https://man7.org/linux/man-pages/man2/unshare.2.html) system call that gives rise to Linux containers.  
...
I concur with Captain Reynolds, but I believe care makes more difference than love.  
Yet I personally do both love and care.

<hr/>

(In the userpic, I'm reading a particularly bad piece of OpenStack codebase printed out by a fellow MIPT student...)
